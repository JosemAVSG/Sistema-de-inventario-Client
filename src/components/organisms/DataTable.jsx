        ...
        return (
          <span
            className={classNames({
              'badge': true,
              'badge-danger': parseInt(stockValue) < 2,
              'badge-success': parseInt(stockValue) >= 2,
            })}
          >
            {stockValue}
          </span>
                  ...
                  >
                    {header.isPlaceholder ? null : (
                      ...
                      >
                        ...
                        {{
                          asc: (
                            <BarsArrowUpIcon className="w-4 h-4 ml-2 text-primary-400" />
                          ),
                          desc: (
                            <BarsArrowDownIcon className="w-4 h-4 ml-2 text-primary-400" />
                          ),
